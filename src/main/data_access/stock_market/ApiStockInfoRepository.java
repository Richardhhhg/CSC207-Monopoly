...
public class ApiStockInfoRepository implements StockRepository {
     ...
     *
     * @param jsonFilePath path of the json file to read data from
     * @return List with stock names
     * @throws IOException when error with reading from json
     */
     ...
     *
     * @param ticker ticker to get info of
     * @return StockInfoDataOutputObject with stock data
     * @throws IOException when error with reading from API
     * @throws InterruptedException when something wrong with API
     */
     ...
     *
     * @param ticker Ticker of stock to get price of
     * @return current price of ticker
     * @throws IOException when error with reading from API
     * @throws InterruptedException when API limits our use
     */
     ...
     * @return map of date and price of stock on that date
     * @throws IOException when failed to read from API
     * @throws InterruptedException when API limits calls
     */
     ...
     *
     * @param prices Price map with historical data
     * @return Average daily returns form the stock
     */
     ...
     *
     * @param values List of values to calculate mean of
     * @return mean of list
     */
     ...
     *
     * @param values List of values to calculate standard dev of
